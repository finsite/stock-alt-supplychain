"""Repo-specific configuration for stock-alt-supplychain."""
...
def get_poller_name() -> str:
    ...
    return get_config_value("POLLER_NAME", "stock_alt_supplychain")


def get_rabbitmq_queue() -> str:
    """Return the RabbitMQ queue name for this poller."""
    return get_config_value("RABBITMQ_QUEUE", "stock_alt_supplychain_queue")
